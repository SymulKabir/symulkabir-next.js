            ...
            <div className="hero-section-wrapper container">
                <div className="hero-container">
                    <div className="description-section">
                        <h3>Hello! I'm</h3>
                        <h2>
                            Symul <span className="last-name">Kabir</span>
                        </h2>
                        <h4>( Full-Stack Developer & DevOps Enthusiast )</h4>
                        <p>
                            {" "}A passionate full stack developer exploring the world of
                            DevOps. Enthusiastically learning to bridge development and
                            operations while building scalable applications and contributing
